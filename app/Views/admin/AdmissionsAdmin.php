		...
		<div class="overflow-x-auto">
			<table class="w-full">
				...
				<thead class="bg-gray-50 border-b border-gray-200">
					<tr>
						<th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase" style="width: 25%;">STUDENT NAME</th>
						<th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase" style="width: 20%;">NIM</th>
						<th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase" style="width: 20%;">COMPOSITE SCORE</th>
						<th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase" style="width: 15%;">STATUS</th>
						<th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase" style="width: 10%;">ACTIONS</th>
					</tr>
				</thead>
							...
							<tr class="hover:bg-gray-50 transition">
								<td class="px-6 py-4">
									<div class="flex items-center gap-3">
										...
										<div>
											<p class="font-semibold text-gray-900 truncate"><?= $mahasiswa['name'] ?></p>
										</div>
									</div>
								</td>
								...
								<td class="px-6 py-4">
									<div class="flex items-center gap-2">
										<p class="text-xl font-bold text-[#6b3a9d]"><?= $mahasiswa['finalScore'] ?? 'N/A' ?></p>
									</div>
								</td>
